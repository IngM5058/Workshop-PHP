            ...
            <tbody class="bg-secondary divide-y divide-accent">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="<?php echo e(route('tasks.edit', $task->id)); ?>" class="hover:text-accent">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php echo e($task->category ? $task->category->name : __('Uncategorized')); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <form action="<?php echo e(route('tasks.destroy', $task->id)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Y3 works\Yapper's workshop\task-master\resources\views/tasks/index.blade.php ENDPATH**/ ?>