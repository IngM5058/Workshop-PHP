...
<body class="bg-primary text-light p-8 font-mono">
    ...
    <div class="max-w-2xl mx-auto bg-secondary rounded-lg shadow-md overflow-hidden">
        <form action="<?php echo e(route('tasks.store')); ?>" method="POST" class="space-y-4 p-6">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<?php /**PATH D:\Y3 works\Yapper's workshop\task-master\resources\views/tasks/create.blade.php ENDPATH**/ ?>